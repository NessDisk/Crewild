...
[System.Serializable]
public class Vieper : CrewildBase
{

    public Vieper(int LvlCritatura)
    {
        Nombre = "";
        NombreTaxonomico = "Vieper";
        descripcion = "Crewild Vegetal sus extremedidades se retuercen como ramas y resortes.";
