...
public class Artflow : CrewildBase
{
    public Artflow(int LvlCritatura)
    {
        Nombre = "";
        NombreTaxonomico = "Artflow";
        descripcion = "Crewild Salvaje astuto a la hora de usar trampas a su favor";
