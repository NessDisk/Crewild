...
public class Kanget : CrewildBase
{
    public Kanget(int LvlCritatura)
    {
        Nombre = "";
        NombreTaxonomico = "Kanget";
        descripcion = "Crewild Salavaje que tiene un baston que maneja con destreza";
