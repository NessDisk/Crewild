...
public class Silvere : CrewildBase
{
    public Silvere(int LvlCritatura)
    {
        Nombre = "";
        NombreTaxonomico = "Silvere";
        descripcion = "Cewild tipo electrico tiene clavos metalicos  en ves de ojos";
