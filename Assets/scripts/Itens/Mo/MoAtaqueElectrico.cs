...
public class MoAtaqueElectrico : BaseItem
{
    public MoAtaqueElectrico()
    {

        this.Nombre = "MoAtaElec";
        this.descripcionItem = "Da el MoAtaqueElectrico al Crewild seleccionado";
        this.Coste = 2000;
        this.cantidad = 1;
    ...
    public override IEnumerator FuncionNormal(int NumQuienRecaeEfecto, CrewildBase crewildBase)
    {
        ...
        {
            if (AtqBase.nombreAtaque == new AtaqueElectrico().nombreAtaque)
            {
                YaseTieneMo = true;
            }
        }
        ...
        if (YaseTieneMo == false)
        {
            ...
            if (CrewildChoiseSelect.instanShare.ejecutaAccion == true)
            {
                ...
                if (contador > 2)
                {
                    ...
                    crewildBase.ataques[CrewildChoiseSelect.instanShare.NumSelectorMo] = new AtaqueElectrico();
